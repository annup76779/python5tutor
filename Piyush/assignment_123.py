...
def multi_coupon_calculator():
    ...
    while True:
        # taking cost input
        spenditure_of_user  = input("Cost of groceries: ")
        if spenditure_of_user.lower() != 'e':
            if spenditure_of_user.isnumeric():
                spenditure_of_user = int(spenditure_of_user)
